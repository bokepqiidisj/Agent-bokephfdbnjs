...
const orgkaya = JSON.parse(fs.readFileSync('./system/database/owner.json'))
...
//====================================\\
let db_respon_list = JSON.parse(fs.readFileSync('./system/database/list-message.json'));
let listStore = JSON.parse(fs.readFileSync('./system/database/list-message.json'));
let set_proses = JSON.parse(fs.readFileSync('./system/database/set_proses.json'));
let set_done = JSON.parse(fs.readFileSync('./system/database/set_done.json'));
...
async function loadingdone () {
    ...
    const imageurl = "https://files.catbox.moe/0r5qko.png";
...
for (let i = 0; i < genalpa.length; i++) {
await sleep(120)
await Zcon.sendMessage(m.chat, {text: genalpa[i], edit: key });
}
}
